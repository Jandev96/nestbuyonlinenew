  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full">
      <h1 className="text-2xl md:text-7xl font-bold">
        We Provide the Best <br /> for our Customers
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-600 dark:text-neutral-200">
      Experience a seamless blend of innovation, quality, and style—curated just for you. Whether you're looking for cutting-edge tech, stunning designs, or everyday essentials, we’ve crafted every detail to exceed your expectations. Start your journey with products that inspire, empower, and deliver.
